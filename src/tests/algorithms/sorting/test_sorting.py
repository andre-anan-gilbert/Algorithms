...
from main.algorithms.sorting.bucket_sort import BucketSort
from main.algorithms.sorting.counting_sort import CountingSort
...
class TestSorting(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._algorithms = {
            ...
            SortingAlgorithm.COUNT_SORT: CountingSort,
        }
